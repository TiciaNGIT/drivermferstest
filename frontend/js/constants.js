const contractAddress = "0xfFd0d2c6f5155A1fa4CCac9a4396cC9312B59Ce4"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the drivermfers NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The drivermfers NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
